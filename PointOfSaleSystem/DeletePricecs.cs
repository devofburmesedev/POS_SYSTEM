...
{
    public partial class DeletePricecs : Form
    {
        public DeletePricecs()
        {
            InitializeComponent();
            productComobox();
            unitComobox();
        ...
        private void DeletePricecs_Load(object sender, EventArgs e)
        {
            productComobox();
            unitComobox();
            comboBoxUPPrice();
        ...
        private void btnPrice_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd;
            con.Open();
            if (btnPrice.Text.ToString().Equals("ဖြတ်မည်") && p_id != null && u_id != null)
            {
